Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Ali Can Bardakci"
  # s.authors            = { "Ali Can Bardakci" => "alicanbardakci@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Ali Can Bardakci"
  ...
  s.source       = { :git => "http://EXAMPLE/GDTableView.git", :tag => "#{s.version}" }
